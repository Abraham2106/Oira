...
**Alcance:** identificar patrones transferibles de scribes humanos y productos de documentación ambiental para NotaLocal.  
...
| Patrón | Scribe humano | Productos ambientales | Copiar / adaptar / prohibir | Por qué para NotaLocal | Fuente |
| --- | --- | --- | --- | --- | --- |
...
| Médico presente con el paciente | El scribe reduce la atención al EHR. | La captura ocurre en segundo plano durante conversación. | **ADAPTAR** | Durante `RECORDING`, NotaLocal debe minimizar distracciones y hacer inequívoco el estado del micrófono; no mostrar live transcript P0. | [S1], [S4] |
...
| EHR como destino directo | El scribe escribe en el EHR de la organización. | Productos integran o preparan contenido para EHR. | **PROHIBIR en P0** | NotaLocal no es EHR ni tiene integración. Copiar al portapapeles/archivo y advertir que el destino queda fuera de alcance. | [S1], [S4] |
| Órdenes, codificación o recomendaciones | Algunos flujos de scribe pueden apoyar tareas delegadas. | Algunos productos anuncian datos/órdenes discretos. | **PROHIBIR** | Rompe el alcance: NotaLocal no diagnostica, prescribe ni recomienda. El producto documenta lo dicho; no crea decisiones clínicas. | [S3], [S5] |
...
- **I4:** que un proveedor use notas por especialidad no autoriza a importar su esquema, títulos oficiales o campos de evaluación/plan. NotaLocal debe renderizar una estructura que describa lo dicho por el médico y coordinarse con IA.
...
- Abridge y Microsoft son **fuentes de proveedor**: son útiles para describir cómo presentan sus productos, pero no para prometer desempeño, precisión, ahorro de tiempo ni seguridad de NotaLocal.
